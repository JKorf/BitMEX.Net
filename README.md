...
* Version 3.11.0 - 08 Jun 2026
    ...
    * Added LastPricePreLaunch value to MarkMethod enum
...
* Version 3.9.0 - 24 Mar 2026
    ...
    * Notes for updating:
        * Update ApiCredentials to BitMEXCredentials for authentication, i.e. `ApiCredentials = new ApiCredentials(..)` => `ApiCredentials = new BitMEXCredentials(..)`
...
* Version 3.1.0 - 07 Jan 2026
    ...
    * Fixed deserialization error on websocket messages with filter

* Version 3.0.1 - 17 Dec 2025
...
* Version 3.0.0 - 16 Dec 2025
    ...
    * Added MRSXXX Enum value to SymbolType enum
...
* Version 2.10.0 - 03 Nov 2025
    ...
    * Fixed deserialization issue in restClient.ExchangeApi.ExchangeData.GetIndicesAsync
...
* Version 2.9.0 - 16 Oct 2025
    ...
    * Fixed occasional deserialization error restClient.ExchangeApi.ExchangeData.GetIndicesAsync
