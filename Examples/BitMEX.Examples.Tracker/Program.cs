...
collection.AddBitMEX();
var provider = collection.BuildServiceProvider();

var trackerFactory = provider.GetRequiredService<IBitMEXTrackerFactory>();

// Create and start the tracker, keep track of the last 10 minutes
var tracker = trackerFactory.CreateTradeTracker(new SharedSymbol(TradingMode.PerpetualLinear, "BTC", "USDT"), period: TimeSpan.FromMinutes(10));
