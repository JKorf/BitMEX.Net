...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Add services such as the IBitMEXRestClient and IBitMEXSocketClient. Configures the services based on the provided configuration.<br />
        /// See <see href="https://github.com/JKorf/BitMEX.Net/blob/main/Examples/example-config.json" /> for an example of how to set up the configuration.
        /// </summary>
        ...
        {
            var options = BitMEXOptions.CreateFromConfiguration(configuration);
        ...
        {
            var options = BitMEXOptions.Create(optionsDelegate);
